...
const FavoriteCharactersScreen = () => {
  ...
  const filteredFavorites = favorites.filter((character) => {
    ...
    const matchesStatus =
      selectedStatus.length === 0 || selectedStatus.includes(character.status);
    ...
    if (selectedSpecies.length > 0) {
      if (selectedSpecies.includes('Other')) {
        ...
        matchesSpecies = selectedSpecies.includes(character.species);
      }
    }
        ...
        >
          ...
          <View style={styles.imageContainer}>
            ...
            <View style={styles.likeButton}>
              <Image source={icon1} style={styles.likeIcon} />
